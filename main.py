...
while True:
    ...
    typewrite("1. Hem afleiden en praten met hem\n\n2. Hem in elkaar slaan\n\n3. Hem afleiden en wegrennen")
    keuze4 = input("> ")
...
if keuze4 == "3":
    while True:
        ...
        if keuze6 == "1":
            ...
            eindigspel = input("Press ENTER to continue ")
            break
